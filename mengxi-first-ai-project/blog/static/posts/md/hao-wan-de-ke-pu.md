...
description: "Getting something from the kurzgesagt shop is the best way to support us and to keep our videos free for everyone. ►► https://kgs.link/shop-159     (Worldwid..."
host: www.youtube.com
favicon: https://www.youtube.com/s/desktop/5ee39131/img/favicon_32x32.png
image: https://i.ytimg.com/vi/LxgMdjyw8uw/maxresdefault.jpg
```

```cardlink
url: https://summarize.ing/zh-CN
title: "Summarize.ing - 即时YouTube视频摘要 | AI驱动内容摘要"
description: "在Summarize.ing上发现快速的AI驱动YouTube视频摘要。在一分钟内获得亮点、思维导图、分段摘要。节省时间，轻松掌握关键内容！"
host: summarize.ing
```
总结

```cardlink
url: https://www.mermaidchart.com/app/projects/c5f5d34a-b7a6-45a0-aaa1-8e987803720a/diagrams/5ee3b377-f7ad-4d15-b95a-1efc7e1bdbed/version/v0.1/edit
