    ...
    card_html = f"""
                        ...
                        <div class="music-ambient-player" style="margin-top: 1.25rem; padding-top: 0.85rem; border-top: 1px solid rgba(255, 255, 255, 0.05); display: flex; flex-direction: column; gap: 8px;">
                            <div style="display: flex; align-items: center; justify-content: space-between; gap: 10px;">
                                <div style="display: flex; flex-direction: column; gap: 3px;">
                                    ...
                                    <div id="ambient-current-track" style="font-size: 0.72rem; color: var(--tg-text-light); opacity: 0.7;">
                                        🎬 治愈系列 · 自动加载网易云
                                    </div>
                                </div>
                                <div style="display: flex; align-items: center;">
                                    <audio id="ambient-audio" src="" style="height: 28px; width: 140px; border-radius: 4px; filter: invert(0.9) hue-rotate(180deg);" controls preload="none"></audio>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        ...
                        function setupAmbientAudio() {{
                            ...
                            if (!selectNode || !audioNode) return;
