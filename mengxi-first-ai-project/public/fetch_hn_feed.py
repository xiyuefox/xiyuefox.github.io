...
"""
    ...
    # 1. 多关键词拉取
    all_queries = ["raspberry pi baby", "baby monitor opencv", "baby crying detection", "parenting", "women startup"]
    all_hits = []
    ...
    for item in all_hits:
        ...
        is_geek = False
        if "raspberry" in title_en.lower() or "baby monitor" in title_en.lower() or "opencv" in title_en.lower() or "github.com" in link.lower():
            is_geek = True
...
"""
    ...
    if not geek_lab and not career_science:
